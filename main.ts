scene.onOverlapTile(SpriteKind.Player, assets.tile`我的貼圖1`, function (sprite, location) {
    ...
    monster_1 = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Enemy)
    monster_1.follow(player_1, 50)
    monster_1_hp = statusbars.create(20, 4, StatusBarKind.Health)
    monster_1_hp.attachToSprite(monster_1)
    for (let index = 0; index < 4; index++) {
        monster_1 = sprites.createProjectileFromSprite(img`
            ........................
            ........................
            ........................
            ........................
...
let monster_1_hp: StatusBarSprite = null
...
statusbar.attachToSprite(player_1, 0, 0)
animation.runImageAnimation(
player_1,
[img`
    . . . . . . f f f f . . . . . . 
...
forever(function () {
    music.playMelody("C C D D C C D D ", 120)
    music.playMelody("C C E E C C E E ", 120)
    music.playMelody("D D F F D D F F ", 120)
    music.playMelody("G G D D G G D D ", 120)
    music.playMelody("G G F D G G F D ", 120)
})
forever(function () {
